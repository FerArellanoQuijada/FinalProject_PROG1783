...
#the idea of the program is goign to bulit a board, when it will be showing tha selections and bombs
#References: https://medium.com/swlh/this-is-how-to-create-a-simple-minesweeper-game-in-python-af02077a8de#:~:text=import%20randomdef%20minesweeper(n%2C%20k)%3A,0%20and%20y%20%3C%3D%204)%3A // https://regex101.com/
